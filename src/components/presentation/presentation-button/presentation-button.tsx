...
class PresentationButton extends Component<PresentationButtonProps, PresentationButtonState> {
    ...
    private enterFullscreen = () => {
        this.setState({
            ...
            const fullscreenView = document.getElementById('presentation-fullscreen-view');
            if (!fullscreenView) {
                return;
            }
